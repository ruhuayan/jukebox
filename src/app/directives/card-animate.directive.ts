...
export class CardAnimateDirective implements OnInit {
    ...
    constructor(
        ...
        @Attribute('cardAnimate') public fromId: string
    ) { }
    ngOnInit() {
      ...
      cardBack.style.top = (initPos.y - destPos.y) + 'px'; // console.log(this.el.nativeElement.parentNode.classList);
      setTimeout(() => {
